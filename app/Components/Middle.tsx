      ...
      <div className="flex flex-col gap-5 w-[700px] max-lg:w-[80%] mx-auto py-24 relative items-center ">
        ...
        <div className="flex justify-center space-x-8 mt-5 z-10">
          <div className="flex items-center space-x-2 text-[wheat] hover:text-white hover:underline quicksand-semibold">
            <img
              src="https://www.infrasity.com/communityIcons/youtube.svg"
              loading="lazy"
              alt="Infrasity Youtube"
              className="w-6 h-6"
            />
            <a
              ...
              className="hover:underline flex items-center max-lg:justify-center space-x-10 gap-2"
            >
              <span>Youtube</span>
            </a>
          </div>
          <div className="flex items-center space-x-2 text-[wheat] hover:text-white hover:underline quicksand-semibold">
            <img
              src="https://www.infrasity.com/communityIcons/devto.svg"
              loading="lazy"
              alt="Infrasity Dev2"
              className="w-6 h-6"
            />
            <a
              href="https://dev.to/infrasity-learning"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:underline flex items-center max-lg:justify-center space-x-10 gap-2"
            >
          ...
          <div className="flex items-center space-x-2 text-[wheat] hover:text-white hover:underline quicksand-semibold">
            <img
              src="https://www.infrasity.com/communityIcons/medium.svg"
              loading="lazy"
              alt="Infrasity Medium"
              className="w-6 h-6"
            />
            <a
              href="https://medium.com/@infrasity.com"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:underline flex items-center max-lg:justify-center space-x-10 gap-2"
            >
        ...
        {/* Decorative SVG & Avatar Section */}
        <div className="absolute top-[145px] max-xs:top-[125px] lg:hidden">
          <img
            src="https://www.infrasity.com/svgPatterns/join-line-6.svg"
            alt="line 6"
            loading="lazy"
            className="max-xs:scale-75 w-full h-full object-cover"
          />
        </div>
        <div className="absolute max-xs:bottom-[40px] bottom-[20px] lg:hidden">
          <img
            src="https://www.infrasity.com/svgPatterns/join-line-5.svg"
            alt="line 5"
            loading="lazy"
            className="max-xs:scale-75 w-full h-full object-cover"
          />
        ...
        <div className="absolute max-xs:scale-75 max-xs:top-[115px] max-xs:left-[calc(50%-150px)] top-[120px] left-[calc(50%-200px)] w-12 h-12 bg-blue-500 rounded-full overflow-hidden lg:hidden">
          <img
            src="https://www.infrasity.com/Testimon/Ayush.png"
            alt="User 1"
            loading="lazy"
        ...
        <div className="absolute max-xs:scale-75 max-xs:bottom-[25px] max-xs:right-[calc(50%-130px)] bottom-[0px] right-[calc(50%-180px)] w-12 h-12 bg-blue-500 rounded-full overflow-hidden lg:hidden">
          <img
            src="https://www.infrasity.com/Testimon/Paras.png"
            alt="User 2"
            loading="lazy"
            className="w-full h-full object-cover"
          />
        ...
        <div className="absolute bottom-[30px] left-[-120px] w-12 h-12 bg-blue-500 rounded-full items-center justify-center overflow-hidden max-lg:hidden">
          <img
            src="https://www.infrasity.com/Testimon/infraperson1.png"
            alt="User 2"
            loading="lazy"
            className="w-full h-full object-cover"
          />
        ...
        <div className="absolute bottom-[25px] right-[-120px] w-12 h-12 bg-blue-500 rounded-full items-center justify-center overflow-hidden max-lg:hidden">
          <img
            src="https://www.infrasity.com/Testimon/Anurag.png"
            alt="User 4"
            loading="lazy"
            className="w-full h-full object-cover"
          />
        ...
        <div className="absolute top-[80px] left-[-90px] max-lg:hidden">
          <img
            src="https://www.infrasity.com/svgPatterns/join-line-1.svg"
            alt="line 1"
            loading="lazy"
            className="w-full h-full object-cover"
          />
        ...
        <div className="absolute bottom-[50px] left-[-120px] max-lg:hidden scale-x-75">
          <img
            src="https://www.infrasity.com/svgPatterns/join-line-2.svg"
            alt="line 2"
            loading="lazy"
            className="w-full h-full object-cover"
          />
        ...
        <div className="absolute top-[60px] right-[-10px] max-lg:hidden">
          <img
            src="https://www.infrasity.com/svgPatterns/join-line-3.svg"
            alt="line 3"
            loading="lazy"
            className="w-full h-full object-cover"
          />
        ...
        <div className="absolute bottom-[45px] right-[-120px] max-md:right-[30%] max-md:bottom-[13%] max-lg:hidden">
          <img
            src="https://www.infrasity.com/svgPatterns/join-line-4.svg"
            alt="line 4"
            loading="lazy"
            className="w-full h-full object-cover"
          />
